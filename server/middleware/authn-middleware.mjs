...
import { verifyAccessToken, validateRefreshTokenForAuth } from '../app/infrastructure/authn/authn-service.mjs';
...
export function authenticateToken(req, res, next) {
  ...
  if (!token && req.cookies.refreshToken) {
    try {
      ...
      const tokenRecord = validateRefreshTokenForAuth(tokenHash);
