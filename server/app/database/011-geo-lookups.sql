...
-- 011-geo-lookups.sql
--
-- Creates the geo_lookups table for storing raw geo responses (exiftool
-- geolocation data, geonames API responses) separately from metadata.
-- =============================================================================

-- ---------------------------------------------------------------------------
-- New table: geo_lookups
-- ---------------------------------------------------------------------------
